...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, out_cache = affine_forward(fc1_out, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dx_out, dW3, db3 = affine_backward(dout, out_cache)
        dfc_out, dW2, db2 = affine_relu_backward(dx_out, fc1_cache)
        dconv_out, dW1, db1 = conv_relu_pool_backward(dfc_out, conv_cache)
